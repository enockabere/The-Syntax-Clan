...
!(function (t, e) {
      ...
      return (
        (e.prototype.render = function (e) {
          ...
          if (
            ...
            this.options &&
              this.options.data &&
              t.each(this.options.data, function (t, e) {
                o.attr("data-" + t, e)
              }),
            this.options &&
              this.options.click &&
    ...
    m = {
      ...
      palette: o('<div class="note-color-palette"/>', function (t, e) {
        for (var o = [], n = 0, i = e.colors.length; n < i; n++) {
          for (
            var r = e.eventName, s = e.colors[n], a = [], l = 0, c = s.length;
            l < c;
            l++
          ) {
            var d = s[l]
      ...
      checkbox: o('<div class="checkbox"></div>', function (t, e) {
        t.html(
          [
            " <label" + (e.id ? ' for="' + e.id + '"' : "") + ">",
            ' <input type="checkbox"' + (e.id ? ' id="' + e.id + '"' : ""),
            (e.checked ? " checked" : "") + "/>",
            e.text ? e.text : "",
            "</label>",
          ].join("")
      ...
      createLayout: function (t, e) {
        var o = (
          e.airMode
            ? m.airEditor([m.editingArea([m.airEditable()])])
            : m.editor([
                m.toolbar(),
                m.editingArea([m.codable(), m.editable()]),
                m.statusbar(),
              ])
        ).render()
        return (
  ...
  if (N) {
    ...
    E && (I = parseFloat(E[1])),
      (E = /Trident\/.*rv:([0-9]{1,}[.0-9]{0,})/.exec(T)) &&
        (I = parseFloat(E[1]))
  }
  var A = /Edge\/\d+/.test(T),
    R = !!window.CodeMirror
  if (!R && S)
    if ("function" == typeof __webpack_require__)
      try {
        require.resolve("codemirror"), (R = !0)
      } catch (t) {}
      ...
      else void 0 !== require.specified && (R = require.specified("codemirror"))
  var L =
  ...
  function M(t) {
    return (
      t && /^BR|^IMG|^HR|^IFRAME|^BUTTON|^INPUT/.test(t.nodeName.toUpperCase())
    )
  }
  function O(t) {
    return !F(t) && t && /^DIV|^P|^LI|^H[1-7]/.test(t.nodeName.toUpperCase())
  }
  var U = z("PRE"),
    j = z("LI")
  var q = z("TABLE"),
    K = z("DATA")
  function V(t) {
    return !(Y(t) || W(t) || _(t) || O(t) || q(t) || Z(t) || K(t))
  }
  function W(t) {
  ...
  function tt(t) {
    return B(t) ? t.nodeValue.length : t ? t.childNodes.length : 0
  }
  function et(t) {
    var e = tt(t)
    return (
      0 === e ||
      (!B(t) && 1 === e && t.innerHTML === X) ||
      !(!x.all(t.childNodes, B) || "" !== t.innerHTML)
    )
  }
  function ot(t) {
    M(t) || tt(t) || (t.innerHTML = X)
  }
  function nt(t, e) {
    for (; t; ) {
      if (e(t)) return t
  ...
  function bt(t, e) {
    ...
    if (dt(t) && (B(t.node) || n)) {
      if (lt(t)) return t.node
      if (ct(t)) return t.node.nextSibling
    }
    ...
    return n.length
      ? 1 === n.length
        ...
        : n.reduce(function (t, n) {
            return (
              t === e.node && (t = bt(e, o)),
              bt({node: n, offset: t ? pt(t) : tt(n)}, o)
            )
          })
      : null
  }
  ...
  var St = {
    ...
    isLeftEdgePointOf: function (t, e) {
      return lt(t) && ut(t.node, e)
    },
    isRightEdgePointOf: function (t, e) {
      return ct(t) && ht(t.node, e)
    },
    prevPoint: mt,
    nextPoint: gt,
    isSamePoint: vt,
    ...
    isCharPoint: function (t) {
      if (!B(t.node)) return !1
      var e = t.node.nodeValue.charAt(t.offset - 1)
      return e && " " !== e && e !== D
    },
    walkPoint: function (t, e, o, n) {
      for (var i = t; i && (o(i), !vt(i, e)); )
        i = gt(i, n && t.node !== i.node && e.node !== i.node)
    },
    ancestor: nt,
    ...
    listDescendant: function (t, e) {
      ...
      return (
        ...
        (function n(i) {
          t !== i && e(i) && o.push(i)
          for (var r = 0, s = i.childNodes.length; r < s; r++)
            n(i.childNodes[r])
        })(t),
        o
      )
    ...
    makeOffsetPath: function (t, e) {
      return it(e, v.eq(t)).map(pt).reverse()
    },
    ...
    isCustomStyleTag: function (t) {
      return t && !B(t) && x.contains(t.classList, "note-styletag")
    },
  }
  ...
  var It = {
    ...
    Tt = {
      isEdit: function (t) {
        return x.contains(
          [It.BACKSPACE, It.TAB, It.ENTER, It.SPACE, It.DELETE],
          t
        )
      },
      isMove: function (t) {
        return x.contains([It.LEFT, It.UP, It.RIGHT, It.DOWN], t)
      },
      nameFromCode: v.invertObject(It),
      code: It,
    }
  function $t(t, e) {
    var o,
  ...
  function Nt(t) {
    var e = function (t, o) {
        ...
        if (St.isText(t)) {
          ...
          ;(n = s || t.parentNode),
            (o += x.sum(x.tail(r), St.nodeLength)),
            (i = !s)
        } else {
      ...
      n = e(t.node, t.offset)
    return (
      o.moveToElementText(n.node),
      o.collapse(n.collapseToStart),
      o.moveStart("character", n.offset),
      o
    )
  }
  var Et = (function () {
      function e(t, e, o, n) {
        ;(this.sc = t),
          ...
          (this.ec = o),
          (this.eo = n),
          (this.isOnEditable = this.makeIsOn(St.isEditable)),
          (this.isOnList = this.makeIsOn(St.isList)),
          (this.isOnAnchor = this.makeIsOn(St.isAnchor)),
          (this.isOnCell = this.makeIsOn(St.isCell)),
          (this.isOnData = this.makeIsOn(St.isData))
      }
      return (
        (e.prototype.nativeRange = function () {
          if (H.isW3CRangeSupport) {
            var t = document.createRange()
            return t.setStart(this.sc, this.so), t.setEnd(this.ec, this.eo), t
          }
          var e = Nt({node: this.sc, offset: this.so})
          return (
            e.setEndPoint("EndToEnd", Nt({node: this.ec, offset: this.eo})), e
          )
        }),
        ...
        (e.prototype.scrollIntoView = function (e) {
          var o = t(e).height()
          return (
            e.scrollTop + o < this.sc.offsetTop &&
              (e.scrollTop += Math.abs(e.scrollTop + o - this.sc.offsetTop)),
            this
          )
        }),
        (e.prototype.normalize = function () {
          var t = function (t, e) {
              if (
                (St.isVisiblePoint(t) && !St.isEdgePoint(t)) ||
                (St.isVisiblePoint(t) && St.isRightEdgePoint(t) && !e) ||
                (St.isVisiblePoint(t) && St.isLeftEdgePoint(t) && e) ||
                (St.isVisiblePoint(t) &&
                  St.isBlock(t.node) &&
                  St.isEmpty(t.node))
              )
              ...
              if (
                ((St.isLeftEdgePointOf(t, o) ||
                  St.isVoid(St.prevPoint(t).node)) &&
                  !e) ||
                ((St.isRightEdgePointOf(t, o) ||
                  St.isVoid(St.nextPoint(t).node)) &&
                  e)
              ) {
              ...
              return (
                (e
                  ? St.nextPointUntil(St.nextPoint(t), St.isVisiblePoint)
                  : St.prevPointUntil(St.prevPoint(t), St.isVisiblePoint)) || t
              )
            },
            ...
            St.walkPoint(
              ...
              function (e) {
                if (!St.isEditable(e.node)) {
                  var i
                  n
                    ? (St.isLeftEdgePoint(e) && a.push(e.node),
                      St.isRightEdgePoint(e) &&
                        x.contains(a, e.node) &&
                        (i = e.node))
                    : (i = o ? St.ancestor(e.node, t) : e.node),
                    i && t(i) && s.push(i)
                }
              },
              !0
        ...
        (e.prototype.commonAncestor = function () {
          return St.commonAncestor(this.sc, this.ec)
        }),
        ...
        (e.prototype.splitText = function () {
          ...
          return (
            St.isText(this.ec) &&
              !St.isEdgePoint(this.getEndPoint()) &&
              this.ec.splitText(this.eo),
            St.isText(this.sc) &&
              !St.isEdgePoint(this.getStartPoint()) &&
              ((o.sc = this.sc.splitText(this.so)),
              (o.so = 0),
              t && ((o.ec = o.sc), (o.eo = this.eo - this.so))),
            new e(o.sc, o.so, o.ec, o.eo)
          )
        }),
        (e.prototype.deleteContents = function () {
          ...
          var o = this.splitText(),
            ...
            i = St.prevPointUntil(o.getStartPoint(), function (t) {
          ...
          return (
            t.each(n, function (t, e) {
              var o = e.parentNode
              i.node !== o && 1 === St.nodeLength(o) && r.push(o),
                St.remove(e, !1)
            }),
        ...
        (e.prototype.makeIsOn = function (t) {
          return function () {
            var e = St.ancestor(this.sc, t)
            return !!e && e === St.ancestor(this.ec, t)
          }
        }),
        (e.prototype.isLeftEdgeOf = function (t) {
          if (!St.isLeftEdgePoint(this.getStartPoint())) return !1
          var e = St.ancestor(this.sc, t)
          return e && St.isLeftEdgeOf(this.sc, e)
        }),
        (e.prototype.isCollapsed = function () {
          return this.sc === this.ec && this.so === this.eo
        }),
        (e.prototype.wrapBodyInlineWithPara = function () {
          if (St.isBodyContainer(this.sc) && St.isEmpty(this.sc))
            return (
              (this.sc.innerHTML = St.emptyPara),
          ...
          if (St.isInline(t.sc)) {
            ...
            ;(o = x.last(n)),
              St.isInline(o) || (o = n[n.length - 2] || t.sc.childNodes[t.so])
          } else o = t.sc.childNodes[t.so > 0 ? t.so - 1 : 0]
          var i = St.listPrev(o, St.isParaInline).reverse()
          if (
            (i = i.concat(St.listNext(o.nextSibling, St.isParaInline))).length
          ) {
        ...
        (e.prototype.getWordRange = function (t) {
          ...
          if (!St.isCharPoint(o)) return this
          var n = St.prevPointUntil(o, function (t) {
            return !St.isCharPoint(t)
          })
          return (
            t &&
              (o = St.nextPointUntil(o, function (t) {
                return !St.isCharPoint(t)
              })),
        ...
        (e.prototype.bookmark = function (t) {
          return {
            s: {path: St.makeOffsetPath(t, this.sc), offset: this.so},
            e: {path: St.makeOffsetPath(t, this.ec), offset: this.eo},
          }
        }),
        (e.prototype.paraBookmark = function (t) {
          return {
            s: {
              path: x.tail(St.makeOffsetPath(x.head(t), this.sc)),
              offset: this.so,
            },
            e: {
              path: x.tail(St.makeOffsetPath(x.last(t), this.ec)),
              offset: this.eo,
            },
          }
        }),
    ...
    At = {
      create: function (t, e, o, n) {
        ...
        return i || 1 !== arguments.length
          ...
          : (i = this.createFromNode(arguments[0])).collapse(
              St.emptyPara === arguments[0].innerHTML
            )
      },
      createFromSelection: function () {
        ...
        if (H.isW3CRangeSupport) {
          ...
          var c = $t(l, !0),
            d = $t(a, !1)
          St.isText(c.node) &&
            St.isLeftEdgePoint(c) &&
            St.isTextNode(d.node) &&
            St.isRightEdgePoint(d) &&
      ...
      createFromNode: function (t) {
        var e = t,
          ...
          i = St.nodeLength(n)
        return (
          St.isVoid(e) && ((o = St.listPrev(e).length - 1), (e = e.parentNode)),
          St.isBR(n)
            ? ((i = St.listPrev(n).length - 1), (n = n.parentNode))
            : St.isVoid(n) && ((i = St.listPrev(n).length), (n = n.parentNode)),
          this.create(e, o, n, i)
        )
      },
  ...
  var Rt = (function () {
    ...
    Lt = (function () {
      function e() {}
      return (
        (e.prototype.jQueryCSS = function (e, o) {
        ...
        (e.prototype.stylePara = function (e, o) {
          t.each(e.nodes(St.isPara, {includeAncestor: !0}), function (e, n) {
            t(n).css(o)
          })
        }),
        (e.prototype.styleNodes = function (e, o) {
          ...
          var s = St.makePredByNodeName(n),
            a = e.nodes(St.isText, {fullyContains: !0}).map(function (t) {
              return St.singleChildAncestor(t, s) || St.wrap(t, n)
            })
          if (i) {
            if (r) {
              var l = e.nodes()
            ...
            return a.map(function (e) {
              ...
              return (
                t.each(i, function (t, e) {
                  St.appendChildNodes(n, e.childNodes), St.remove(e)
                }),
                x.head(o)
              )
            })
        ...
        (e.prototype.current = function (e) {
          ...
          if (r && r.style["line-height"]) n["line-height"] = r.style.lineHeight
            ...
            var s =
              parseInt(n["line-height"], 10) / parseInt(n["font-size"], 10)
            n["line-height"] = s.toFixed(1)
          }
          return (
            (n.anchor = e.isOnAnchor() && St.ancestor(e.sc, St.isAnchor)),
            (n.ancestors = St.listAncestor(e.sc, St.isEditable)),
            (n.range = e),
            n
          )
        }),
    ...
    Pt = (function () {
      function e() {}
      return (
        (e.prototype.insertOrderedList = function (t) {
        ...
        (e.prototype.toggleList = function (e, o) {
          ...
          if (x.find(r, St.isPurePara)) {
            ...
            var c = i
              .nodes(St.isList, {includeAncestor: !0})
              .filter(function (o) {
                return !t.nodeName(o, e)
              })
            c.length
              ? t.each(c, function (t, o) {
                  St.replace(o, e)
                })
        ...
        (e.prototype.wrapList = function (t, e) {
          ...
          return (
            (t = t.map(function (t) {
              return St.isPurePara(t) ? St.replace(t, "LI") : t
            })),
            St.appendChildNodes(s, t),
            r && (St.appendChildNodes(s, x.from(r.childNodes)), St.remove(r)),
            t
          )
        }),
              ...
              var r = x.head(i),
                ...
                l =
                  a.childNodes.length > 1
                    ? St.splitTree(
                        a,
                        {node: s.parentNode, offset: St.position(s) + 1},
                        {isSkipPaddingBlankHTML: !0}
                      )
                    : null,
                c = St.splitTree(
                  a,
                  {node: r.parentNode, offset: St.position(r)},
                  {isSkipPaddingBlankHTML: !0}
                )
              ;(i = o
                ? St.listDescendant(c, St.isLi)
                : x.from(c.childNodes).filter(St.isLi)),
                (!o && St.isList(a.parentNode)) ||
                  (i = i.map(function (t) {
                    return St.replace(t, "P")
                  })),
                t.each(x.from(i).reverse(), function (t, e) {
                  St.insertAfter(e, a)
                })
    ...
    Ht = (function () {
      ...
      return (
        (e.prototype.insertTab = function (t, e) {
        ...
        (e.prototype.insertParagraph = function (e) {
          ...
          var n,
            i = St.ancestor(o.sc, St.isPara)
          if (i) {
            if (St.isEmpty(i) && St.isLi(i))
              return void this.bullet.toggleList(i.parentNode.nodeName)
            if (St.isEmpty(i) && St.isPara(i) && St.isBlockquote(i.parentNode))
              St.insertAfter(i, i.parentNode), (n = i)
            else {
              n = St.splitTree(i, o.getStartPoint())
              var r = St.listDescendant(i, St.isEmptyAnchor)
              ;(r = r.concat(St.listDescendant(n, St.isEmptyAnchor))),
                t.each(r, function (t, e) {
                  St.remove(e)
                }),
                (St.isHeading(n) || St.isPre(n) || St.isCustomStyleTag(n)) &&
                  St.isEmpty(n) &&
                  (n = St.replace(n, "p"))
            }
          } else {
            ...
            ;(n = t(St.emptyPara)[0]),
              s ? o.sc.insertBefore(n, s) : o.sc.appendChild(n)
          }
    ...
    Dt = function (t, e, o, n) {
      ...
      function l(t, e) {
        if (!r[t]) return e
        if (!r[t][e]) return e
        for (var o = e; r[t][o]; ) if ((o++, !r[t][o])) return o
      }
      function c(t, e) {
      ...
      ;(this.getActionList = function () {
        for (
          var t = e === Dt.where.Row ? i.rowPos : -1,
            n = e === Dt.where.Column ? i.colPos : -1,
            a = 0,
            l = !0;
          l;
          ...
          s.push(
            ...
            (b = d),
            {
              baseCell: f.baseCell,
              action: g,
              virtualTable: {rowIndex: v, cellIndex: b},
            })
          ),
            a++
        }
  ...
  ;(Dt.where = {Row: 0, Column: 1}),
    (Dt.requestAction = {Add: 0, Delete: 1}),
    (Dt.resultAction = {
      Ignore: 0,
      SubtractSpanCount: 1,
      RemoveCell: 2,
        ...
        (e.prototype.addCol = function (e, o) {
          ...
          for (
            ...
            switch (a.action) {
              case Dt.resultAction.AddCell:
                "right" === o
                  ? t(a.baseCell).after("<td" + l + ">" + St.blank + "</td>")
                  : t(a.baseCell).before("<td" + l + ">" + St.blank + "</td>")
                break
              case Dt.resultAction.SumSpanCount:
                if ("right" === o) {
        ...
        (e.prototype.deleteRow = function (e) {
          for (
            var o = St.ancestor(e.commonAncestor(), St.isCell),
              n = t(o).closest("tr"),
              i = n.children("td, th").index(t(o)),
              r = n[0].rowIndex,
              s = new Dt(
                o,
                Dt.where.Row,
                Dt.requestAction.Delete,
                t(n).closest("table")[0]
              ).getActionList(),
              a = 0;
            a < s.length;
              ...
              switch (s[a].action) {
                ...
                case Dt.resultAction.AddCell:
                  ...
                  d &&
                    (u > 2
                      ? (u--,
                        h.insertBefore(p, h.cells[i]),
                        h.cells[i].setAttribute("rowSpan", u),
                        (h.cells[i].innerHTML = ""))
                      : 2 === u &&
                        (h.insertBefore(p, h.cells[i]),
              ...
              switch (r[s].action) {
                ...
                case Dt.resultAction.SubtractSpanCount:
                  ...
                  if (a.colSpan && a.colSpan > 1) {
                    ...
                    l > 2
                      ? (l--,
                        a.setAttribute("colSpan", l),
                        a.cellIndex === i && (a.innerHTML = ""))
                      : 2 === l &&
    ...
    Bt = (function () {
      function e(e) {
        ...
        ;(this.context = e),
          ...
          (this.typing = new Ht()),
          (this.bullet = new Pt()),
          (this.history = new Rt(this.$editable)),
        ...
        ;(this.insertParagraph = this.wrapCommand(function () {
          ...
          (this.insertNode = this.wrapCommand(function (e) {
            if (!o.isLimited(t(e).text().length)) {
              o.createRange().insertNode(e), At.createFromNodeAfter(e).select()
            }
          })),
          ...
          (this.createLink = this.wrapCommand(function (e) {
            ...
            "string" == typeof n && (n = n.trim()),
              (n = o.options.onCreateLink
                ...
                : /^[A-Za-z][A-Za-z0-9+-.]*\:[\/\/]?/.test(n)
                ? n
                : "http://" + n)
            var l = []
            if (a) {
              var c = (s = s.deleteContents()).insertNode(
                t("<A>" + i + "</A>")[0]
              )
              l.push(c)
            ...
            t.each(l, function (e, o) {
              t(o).attr("href", n),
                r ? t(o).attr("target", "_blank") : t(o).removeAttr("target")
            })
          ...
          (this.removeMedia = this.wrapCommand(function () {
            ...
            e.parent("figure").length
              ? e.parent("figure").remove()
              : (e = t(o.restoreTarget()).detach()),
              o.context.triggerEvent("media.delete", e, o.$editable)
          })),
          (this.floatMe = this.wrapCommand(function (e) {
            var n = t(o.restoreTarget())
            n.toggleClass("note-float-left", "left" === e),
              n.toggleClass("note-float-right", "right" === e),
              n.css("float", e)
          })),
      ...
      return (
        (e.prototype.initialize = function () {
          ...
          this.$editable
            ...
            this.$editable.html(St.html(this.$note) || St.emptyPara),
            this.$editable.on(
              H.inputEventName,
              v.debounce(function () {
        ...
        (e.prototype.handleKeyMap = function (t) {
          ...
          i
            ...
            : Tt.isEdit(t.keyCode) && this.afterCommand()
        }),
          ...
          return (
            ...
            (void 0 === e ||
              !(
                ...
                e.ctrlKey ||
                e.metaKey ||
                x.contains([Tt.code.BACKSPACE, Tt.code.DELETE], e.keyCode)
              )) &&
        ...
        (e.prototype.createRange = function () {
          return this.focus(), At.create(this.editable)
        }),
        ...
        (e.prototype.getSelectedText = function () {
          ...
          return (
            t.isOnAnchor() &&
              (t = At.createFromNode(St.ancestor(t.sc, St.isAnchor))),
            t.toString()
          )
        }),
        ...
        (e.prototype.fontStyling = function (e, o) {
          ...
          if (n) {
            ...
            if ((t(i).css(e, o), n.isCollapsed())) {
              ...
              r &&
                !St.nodeLength(r) &&
                ((r.innerHTML = St.ZERO_WIDTH_NBSP_CHAR),
                At.createFromNodeAfter(r.firstChild).select(),
        ...
        (e.prototype.isEmpty = function () {
          return (
            St.isEmpty(this.$editable[0]) ||
            St.emptyPara === this.$editable.html()
          )
        }),
        (e.prototype.empty = function () {
          this.context.invoke("code", St.emptyPara)
        }),
        e
      )
    })(),
              ...
              .on("drop", function (o) {
                ...
                o.preventDefault(),
                  n && n.files && n.files.length
                    ...
                    : t.each(n.types, function (o, i) {
                        var r = n.getData(i)
                        i.toLowerCase().indexOf("text") > -1
                          ? e.context.invoke("editor.pasteHTML", r)
                          : t(r).each(function (t, o) {
  ...
  var Ut = (function () {
      ...
      return (
        ...
        (t.prototype.activate = function () {
          ...
          if (
            (this.$codable.val(
              St.html(this.$editable, this.options.prettifyHtml)
            ),
        ...
        (t.prototype.deactivate = function () {
          ...
          var e =
              St.value(this.$codable, this.options.prettifyHtml) ||
              St.emptyPara,
                  ...
                  n = function (e) {
                    ...
                    ;(n =
                      t.options.minheight > 0
                        ? Math.max(n, t.options.minheight)
                        : n),
                      (n =
                        t.options.maxHeight > 0
                          ? Math.min(n, t.options.maxHeight)
                          : n),
                      t.$editable.height(n)
                  }
    ...
    qt = (function () {
      function e(e) {
        ...
        ;(this.context = e),
          ...
          (this.$scrollbar = t("html, body")),
          (this.onResize = function () {
            o.resizeTo({h: o.$window.height() - o.$toolbar.outerHeight()})
          })
      }
      return (
        (e.prototype.resizeTo = function (t) {
              ...
              if (St.isControlSizing(t.target)) {
                ...
                var o = e.$handle
                  ...
                  r = function (t) {
                    e.context.invoke(
                      "editor.resizeTo",
                      {x: t.clientX - n.left, y: t.clientY - (n.top - i)},
                      o,
                      !t.shiftKey
                    ),
                      e.update(o[0])
    ...
    Wt = (function () {
      ...
      return (
        ...
        (e.prototype.handleKeyup = function (t) {
          x.contains([Tt.code.ENTER, Tt.code.SPACE], t.keyCode) &&
            this.replace()
        }),
        e
      )
    ...
    _t = (function () {
      ...
      return (
        (t.prototype.shouldInitialize = function () {
          return St.isTextarea(this.$note[0])
        }),
        t
      )
    })(),
    Gt = (function () {
      ...
      return (
        (e.prototype.shouldInitialize = function () {
          return !!this.options.placeholder
        }),
        (e.prototype.initialize = function () {
          var e = this
          ;(this.$placeholder = t('<div class="note-placeholder">')),
            this.$placeholder
              .on("click", function () {
    ...
    Zt = (function () {
      function e(e) {
        ;(this.ui = t.summernote.ui),
          (this.context = e),
          (this.$toolbar = e.layoutInfo.toolbar),
          (this.options = e.options),
          (this.lang = this.options.langInfo),
          (this.invertedKeyMap = v.invertObject(
            this.options.keyMap[H.isMac ? "mac" : "pc"]
          ))
      }
      return (
        (e.prototype.representShortcut = function (t) {
          var e = this.invertedKeyMap[t]
          return this.options.shortcuts && e
            ? (H.isMac && (e = e.replace("CMD", "⌘").replace("SHIFT", "⇧")),
              " (" +
                (e = e
                  .replace("BACKSLASH", "\\")
                  .replace("SLASH", "/")
        ...
        (e.prototype.addToolbarButtons = function () {
                ...
                e.ui.dropdown({
                  ...
                  template: function (t) {
                    "string" == typeof t &&
                      (t = {
                        tag: t,
                        title: e.lang.style.hasOwnProperty(t)
                          ? e.lang.style[t]
                          : t,
                      })
                    var o = t.tag,
          ...
          for (
            var o = function (t, o) {
                ...
                n.context.memo("button.style." + i, function () {
                  return e
                    .button({
                      ...
                      click:
                        e.context.createInvokeHandler("editor.formatBlock"),
                    })
                    .render()
                })
              },
              n = this,
              i = 0,
              r = this.options.styleTags.length;
            i < r;
            i++
          )
            o(i)
          this.context.memo("button.bold", function () {
            return e
              .button({
                ...
                click:
                  e.context.createInvokeHandlerAndUpdateState("editor.bold"),
              })
              .render()
          }),
            ...
            this.context.memo("button.underline", function () {
              return e
                .button({
                  ...
                  tooltip:
                    e.lang.font.underline + e.representShortcut("underline"),
                  click:
                    e.context.createInvokeHandlerAndUpdateState(
                      "editor.underline"
                    ),
            ...
            this.context.memo("button.clear", function () {
              return e
                .button({
                  ...
                  tooltip:
                    e.lang.font.clear + e.representShortcut("removeFormat"),
            ...
            this.context.memo("button.fontname", function () {
              ...
              return (
                t.each(o["font-family"].split(","), function (o, n) {
                  ;(n = n.trim().replace(/['"]+/g, "")),
                    e.isFontDeservedToAdd(n) &&
                      -1 === t.inArray(n, e.options.fontNames) &&
                ...
                .buttonGroup({
                  ...
                  children: [
                    e.button({
                      ...
                      contents: e.ui.icon(
                        e.options.icons.font + " note-recent-color"
                      ),
                    ...
                    e.ui.dropdown({
                      ...
                      click: function (o) {
                        ...
                        if (i && r) {
                          var s =
                              "backColor" === i ? "background-color" : "color",
                            a = n
                              .closest(".note-color")
                              .find(".note-recent-color"),
                            l = n
          ...
          this.context.memo("button.justifyLeft", v.invoke(s, "render")),
            this.context.memo("button.justifyCenter", v.invoke(a, "render")),
            this.context.memo("button.justifyRight", v.invoke(l, "render")),
            this.context.memo("button.justifyFull", v.invoke(c, "render")),
            this.context.memo("button.outdent", v.invoke(d, "render")),
                  ...
                  ],
                  {
                    callback: function (t) {
                      t.find(".note-dimension-picker-mousecatcher")
                        ...
                        .mousedown(
                          e.context.createInvokeHandler("editor.insertTable")
                        )
            ...
            this.context.memo("button.link", function () {
              return e
                .button({
                  ...
                  tooltip:
                    e.lang.link.link + e.representShortcut("linkDialog.show"),
        ...
        (e.prototype.build = function (e, o) {
          for (var n = 0, i = o.length; n < i; n++) {
            for (
              var r = o[n],
                s = t.isArray(r) ? r[0] : r,
                a = t.isArray(r) ? (1 === r.length ? [r[0]] : r[1]) : [r],
                l = this.ui.buttonGroup({className: "note-" + s}).render(),
                c = 0,
                d = a.length;
              c < d;
              c++
        ...
        (e.prototype.tableMoveHandler = function (e) {
          ...
          s.css({width: c + "em", height: d + "em"}),
            r.data("value", c + "x" + d),
            c > 3 &&
              c < this.options.insertTableMaxSize.col &&
              a.css({width: c + 1 + "em"}),
            d > 3 &&
              d < this.options.insertTableMaxSize.row &&
              a.css({height: d + 1 + "em"}),
            i.html(c + " x " + d)
        }),
        e
      ...
      return (
        ...
        (e.prototype.followScroll = function () {
          ...
          this.options.otherStaticBar &&
            (r = t(this.options.otherStaticBar).outerHeight())
          var s = this.$document.scrollTop(),
            a = this.$editor.offset().top
          s > a - r && s < a + o - r - i
            ? this.$toolbar.css({position: "fixed", top: r, width: n})
      ...
      return (
        (e.prototype.initialize = function () {
          var e = this.options.dialogsInBody ? this.$body : this.$editor,
            ...
            n =
              '<button type="submit" href="#" class="btn btn-primary note-btn note-btn-primary note-link-btn" disabled>' +
            ...
            .Deferred(function (t) {
              ...
              o.ui.onDialogShown(o.$dialog, function () {
                ...
                i
                  ...
                  .val(e.url),
                  H.isSupportTouch || i.trigger("focus"),
      ...
      return (
        (e.prototype.initialize = function () {
          ...
          var i = [
            ...
            r =
              '<button type="submit" href="#" class="btn btn-primary note-btn note-btn-primary note-image-btn" disabled>' +
            ...
            e.ui.onDialogShown(e.$dialog, function () {
              e.context.triggerEvent("dialog.shown"),
                ...
                n
                  ...
                  .val(""),
                H.isSupportTouch || n.trigger("focus"),
                e.bindEnterKey(n, i)
            }),
              e.ui.onDialogHidden(e.$dialog, function () {
                o.off("change"),
                  n.off("keyup paste keypress"),
                  i.off("click"),
                  "pending" === t.state() && t.reject()
              }),
      ...
      return (
        ...
        (e.prototype.initialize = function () {
          ...
          this.context.invoke("buttons.build", t, this.options.popover.table),
            H.isFF && document.execCommand("enableInlineTableEditing", !1, !1)
        }),
        (e.prototype.destroy = function () {
          this.$popover.remove()
        }),
      ...
      return (
        (e.prototype.initialize = function () {
          var t = this.options.dialogsInBody ? this.$body : this.$editor,
            ...
            o =
              '<button type="submit" href="#" class="btn btn-primary note-btn note-btn-primary note-video-btn" disabled>' +
        ...
        (e.prototype.createVideoNode = function (e) {
          ...
          if (n && 11 === n[1].length) {
            ...
            o = t("<iframe>")
              .attr("frameborder", 0)
              .attr("src", "//www.youtube.com/embed/" + f)
              .attr("width", "640")
              .attr("height", "360")
          } else if (i && i[0].length)
            o = t("<iframe>")
              .attr("frameborder", 0)
              .attr("src", "https://instagram.com/p/" + i[1] + "/embed/")
              .attr("width", "612")
              .attr("height", "710")
              .attr("scrolling", "no")
            ...
            o = t(
              ...
              .attr(
                "src",
                "http://v.qq.com/iframe/player.html?vid=" + m + "&amp;auto=0"
              )
          } else {
            if (!(u || h || p)) return !1
            o = t("<video controls>")
          ...
          return Object.keys(o)
            .map(function (n) {
              ...
              return (
                r
                  .append(
                    t("<label><kbd>" + n + "</kdb></label>").css({
                      width: 180,
                      "margin-right": 10,
                    })
                  )
                  .append(t("<span/>").html(e.context.memo("help." + i) || i)),
                r.html()
              )
            })
            .join("")
        ...
        ;(this.context = e),
          ...
          (this.events = {
            ...
            "summernote.focusout": function (t, e) {
              H.isFF ||
                (e.relatedTarget &&
                  St.ancestor(e.relatedTarget, v.eq(o.$popover[0]))) ||
                o.hide()
            },
          })
      }
    ...
    re = (function () {
      function e(e) {
        ...
        ;(this.context = e),
          ...
          (this.hints = t.isArray(this.hint) ? this.hint : [this.hint]),
          (this.events = {
      ...
      return (
        ...
        (e.prototype.createItemTemplates = function (e, o) {
          ...
          return o.map(function (o, i) {
            ...
            return (
              r.append(n.template ? n.template(o) : o + ""),
              r.data({index: e, item: o}),
              r
            )
          })
        }),
        (e.prototype.handleKeydown = function (t) {
          this.$popover.is(":visible") &&
            (t.keyCode === Tt.code.ENTER
              ...
              : t.keyCode === Tt.code.UP
              ? (t.preventDefault(), this.moveUp())
              : t.keyCode === Tt.code.DOWN &&
        ...
        (e.prototype.createGroup = function (e, o) {
          ...
          return (
            this.searchKeyword(e, o, function (t) {
              ;(t = t || []).length &&
                (i.html(n.createItemTemplates(e, t)), n.show())
            }),
            i
          )
        }),
        (e.prototype.handleKeyup = function (t) {
          var e = this
          if (
            !x.contains([Tt.code.ENTER, Tt.code.UP, Tt.code.DOWN], t.keyCode)
          ) {
    ...
    se = (function () {
      ...
      return (
        ...
        (e.prototype.initializeModule = function (t) {
          ...
          ;(e.shouldInitialize = e.shouldInitialize || v.ok),
            e.shouldInitialize() &&
              ...
              e.events && St.attachEvents(this.$note, e.events))
        }),
        ...
        (e.prototype.removeModule = function (t) {
          var e = this.modules[t]
          e.shouldInitialize() &&
            (e.events && St.detachEvents(this.$note, e.events),
            e.destroy && e.destroy()),
  ...
  t.fn.extend({
    summernote: function () {
      ...
      ;(i.langInfo = t.extend(
        !0,
        {},
        t.summernote.lang["en-US"],
        t.summernote.lang[i.lang]
      )),
        (i.icons = t.extend(!0, {}, t.summernote.options.icons, i.icons)),
        (i.tooltip = "auto" === i.tooltip ? !H.isSupportTouch : i.tooltip),
