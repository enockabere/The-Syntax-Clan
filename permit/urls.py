...
urlpatterns = [
    ...
    path(
        ...
        views.WholesaleApplications.as_view(),
    ...
    path(
        "PrintWholesalePermitApplicationForm/<str:pk>/",
        views.PrintWholesalePermitApplicationForm.as_view(),
        name="PrintWholesalePermitApplicationForm",
    ),
]
