...
urlpatterns = [
    ...
    path("selfservice/", include("registration.urls")),
    ...
    path("selfservice/", include("variation.urls")),
    path("selfservice/", include("appeal.urls")),
    path("selfservice/", include("payment.urls")),
    path("selfservice/", include("retention.urls")),
    path("selfservice/", include("renewal.urls")),
    path("selfservice/", include("gmp.urls")),
