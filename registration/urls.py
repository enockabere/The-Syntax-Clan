...
urlpatterns = [
    ...
    path(
        "country/registered/<str:pk>", views.CountryRegistered, name="CountryRegistered"
    ),
    path(
        "marketing/authorization/<str:pk>",
        views.MarketingAuthorization,
    ...
    path(
        "FnDeleteDocumentAttachment/<str:pk>",
        views.FnDeleteDocumentAttachment,
        name="FnDeleteDocumentAttachment",
    ),
    path("FnRegulatory/<str:pk>", views.FnRegulatory, name="FnRegulatory"),
    path(
        "FnGenerateReceipt/<str:pk>",
        views.FnGenerateReceipt.as_view(),
        name="FnGenerateReceipt",
    ),
