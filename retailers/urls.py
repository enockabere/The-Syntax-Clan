...
urlpatterns = [
    ...
    path(
        "RetailApplications/",
        views.RetailApplications.as_view(),
        name="RetailApplications",
    ),
    path(
        "retailer/<str:pk>/",
    ...
    path(
        "PrintRetailDealersPermitApplicationForm/<str:pk>/",
        views.PrintRetailDealersPermitApplicationForm.as_view(),
        name="PrintRetailDealersPermitApplicationForm",
    ),
]
